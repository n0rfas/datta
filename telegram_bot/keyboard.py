...
def get_keyboard(hero_position: tuple[int, int]) -> InlineKeyboardMarkup:
    ...
    if hero_position[0] == 0:  # left
        keyboard[1][0] = wall_button
    elif hero_position[0] == CARS_SIZE - 1:  # right
        keyboard[1][2] = wall_button

    if hero_position[1] == 0:  # top
        keyboard[0][1] = wall_button
    elif hero_position[1] == CARS_SIZE - 1:  # down
